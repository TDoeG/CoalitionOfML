...
class ColorizationModel(nn.Module):
    def __init__(self):
        ...
        # Adjusted based on encoder output
        self.fc1 = nn.Linear(32 * 13 * 13, 1024)  # Flattened size after the encoder
        self.fc2 = nn.Linear(1024, 4096)
        self.fc3 = nn.Linear(4096, 32 * 25 * 25)  # Reshape to match decoder input
    ...
    def forward(self, x):
        ...
        # Reshape for the decoder
        x = x.view(x.size(0), 32, 25, 25)  # Reshape to match decoder input dimensions
