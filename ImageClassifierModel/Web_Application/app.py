...
sys.path.append(os.path.abspath('./ImageClassifierModel'))
...
UPLOAD_FOLDER = 'ImageClassifierModel/Web_Application/static/uploads/'
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

# Load model
model_path = 'ImageClassifierModel/Saved_Models/80.00_6cifar10_cnn.pth'  # Replace with your actual model path
model = Net()
